...
/*   Updated: 2023/09/08 16:46:20 by sde-mull         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " << B_GREEN "Nameless god summoned" RESET << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << "ClapTrap "  << B_MAGENTA << name << B_GREEN " summoned to the realm" RESET << std::endl;
}

ClapTrap::~ClapTrap(void)
{
	std::cout << "ClapTrap "  << B_MAGENTA << this->_name << B_RED " returned to Mount Olympus" RESET << std::endl;
}

ClapTrap::ClapTrap( ClapTrap const & src)
{
    std::cout << "ClapTrap "  << B_YELLOW "ClapTrap copy constructor called" RESET << std::endl;
    *this = src;
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    std::cout << B_MAGENTA << this->_name << B_YELLOW " got hit by " B_RED << amount << B_YELLOW " damage 💥" RESET<< std::endl;
}
