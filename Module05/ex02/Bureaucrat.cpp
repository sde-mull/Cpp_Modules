...
/*   Updated: 2023/09/14 19:14:23 by sde-mull         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signAForm(std::string const formName, bool sign)
{
...
void Bureaucrat::executeForm(AForm const & form) const
{
    ...
    if (form.getSign() && (form.getGradeToExecute() > this->_grade))
